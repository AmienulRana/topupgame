    ...
    <>
      <div className="purchase pt-md-50 pt-30">
        ...
        <p className="text-lg color-palette-1 mb-20">
          Your Game ID{" "}
          <span className="purchase-details">{dataTopUp?.idPlayer}</span>
        </p>
        <p className="text-lg color-palette-1 mb-20">
          Your username{" "}
          <span className="purchase-details">{dataTopUp?.username}</span>
        </p>
        <p className="text-lg color-palette-1 mb-20">
          Item{" "}
...
export default DetailCheckoutItem;
